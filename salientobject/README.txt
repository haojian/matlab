...
NEW SAMPLING:
Version V2.0 includes a mex file (segmentmax.cpp) that computes faster the segmentation [3]. In this version we also provide a function (computeObjectnessHeatMap.m) to visualize the objectness heat map for an input image. This map ussually shows peaks at object locations. 
...
computes the objectness heat map of an image
Input:
    img - input image;
...
2.0
---
- mex file to fastly compute the segmentation [3] added

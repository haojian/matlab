Code repository for rcnn package used by the Visual Computing group based off of https://github.com/rbgirshick/rcnn.git

The .gitignore file has been renamed to _gitignore to preserve some useful files.

The data and model files that are normally downloaded to data/ are located in /mnt/dp2/visualcomputing/rcnn/data.

To use these files, do the following:

> cd <root-dir>/rcnn/data<br>
> ln -s /mnt/dp2/visualcomputing/rcnn/data/caffe_nets<br> 
> ln -s	/mnt/dp2/visualcomputing/rcnn/data/rcnn_models<br>

To set up caffe, do the following:

> cd <root-dir>/rcnn/external<br>
> ln -s /mnt/dp3/packages/caffe<br>
